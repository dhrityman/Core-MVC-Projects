...
{
    /// <summary>
    /// Step 8: Create a migration class named FirstMigration that inherits from Migration. This class defines the Up and Down methods to create and drop the Products table in the database.
    /// </summary>
